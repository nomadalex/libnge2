...
macro(fix_ios_names PREFIX)
  if(IOS_PLATFORM)
	if(${IOS_PLATFORM} STREQUAL "OS")
	  set(IOS_POSTFIXS "iPhoneOS")
	elseif(${IOS_PLATFORM} STREQUAL "SIMULATOR")
	  set(IOS_POSTFIXS "Simulator")
	endif()

	foreach(i ${${PREFIX}})
	  foreach(_fix ${IOS_POSTFIXS})
		list(APPEND ${PREFIX} "${i}${_fix}")
	  endforeach()
	endforeach()
  endif()
endmacro()
...
macro(define_find_pkg PKG)
  ...
  fix_ios_names(${PKG}_LIBRARY_NAMES)
